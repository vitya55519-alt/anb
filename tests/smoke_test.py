...
assert character['visual_identity']['identity_version']=='anna_v4_two_cafe_canonical_2026_08_14'
...
for ref in ('00_anna_canonical_face_v3.png','01_anna_canonical_look_v3.png'):
    assert (ROOT/character['visual_identity']['reference_folder']/ref).exists(), ref
...
assert '00_anna_canonical_face_v3.png' in photo and '01_anna_canonical_look_v3.png' in photo
assert 'identity_engine=v3' in photo
assert 'ANNA_FACE_IDENTITY' in photo and 'ANNA_BODY_IDENTITY' in photo
