...
def test_version_bumped():
    assert VERSION in ('3.44.4', '3.44.3', '3.43.7', '3.43.6', '3.43.5', '3.43.4', '3.43.3', '3.43.2', '3.43.1', '3.43.0', '3.42.2', '3.42.1', '3.42.0', '3.41.0', '3.40.0', '3.31.8', '3.32.0', '3.32.1', '3.33.0', '3.33.1', '3.34.0', '3.34.1', '3.35.0', '3.36.0', '3.37.0', '3.38.0', '3.39.0')
...
def test_legal_row_always_visible_in_main_keyboard():
    ...
    # bottom of MAIN_KB_ROWS again. V3.42.0: it now shares the bottom row with
    # support («['support', 'legal']»). Compliance is belt-and-braces: the row,
