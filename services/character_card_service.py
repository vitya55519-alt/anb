...
DEFAULT_CARDS = {
    ...
    "luna_01": {
        ...
        "gender": "female",
        "age": 26,
        "short_bio": "Фотограф-богема. Видит красоту в каждом изгибе. Любит эксперименты, ночные прогулки и долгие сеансы в студии.",
        "status": "active",
        "button_emoji": "📸",
        "is_visible": True,
    },
...
SCENARIO_HOOKS = {
    ...
    "luna_01": (
        "Студия завалена принтами. Луна в чёрном боди поправляет свет: "
        "«Стой так. Не двигайся. Этот свет… он создан для твоих линий. Сейчас будет магия.»"
    ),
    "rex_01": (
