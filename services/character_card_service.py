...
SCENARIO_HOOKS = {
    ...
    "sasha_01": (
        "Комната в неоновом свете. Саша в розовом кроп-топе поправляет телефон: "
        "«Привет! Только что записала новое видео. Хочешь посмотреть? Или лучше снимем что-то вместе?..»"
    ),
    "rex_01": (
