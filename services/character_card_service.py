...
SCENARIO_HOOKS = {
    ...
    "alena_01": (
        "Она сидит на скамейке в парке — светлые волосы с карамельными прядями, кольцо в носу. "
        "Замечает тебя и улыбается: «Привет! Я тут подумала… прогулка вдвоём была бы лучше. Составишь компанию?»"
    ),
    "maria_01": (
        "Мэри в зелёном кроп-топе и юбке сидит на скамейке — блондинка с зелёными глазами, сумочка через плечо. "
        "Поднимает взгляд: «Эй! Я как раз думала, кто бы составил мне компанию. Присоединишься?»"
    ),
    "maksim_01": (
    ...
    "kate_01": (
        "Она только что закончила тренировку — спортивный топ, капли пота на прессе. "
        "«Ты опоздал на пять минут. Знаешь, что это значит? Двойная нагрузка. Начнём с разминки…»"
    ),
    "sasha_01": (
        "Саша в зелёном комплекте сидит на скамейке в парке — светлые волосы в хвосте, зелёные глаза. "
        "Поправляет сумочку и смотрит на тебя: «Привет! Гуляешь? Составь компанию, а то одной скучно.»"
    ),
    "rex_01": (
