...
DEFAULT_CARDS = {
    ...
    "erika_01": {
        ...
        "gender": "female",
        "age": 38,
        "short_bio": "Элегантная и очень женственная. Мать твоего друга — она наливает тебе вино и смотрит так, что забываешь, зачем пришёл.",
        "status": "active",
        "button_emoji": "🌹",
        "is_visible": True,
    },
    "sonya_01": {
        ...
        "gender": "female",
        "age": 22,
        "short_bio": "Подруга детства — переехала в твой город. Дразнится, вспоминает ваши тайны и вдруг робеет, когда ты становишься ближе, чем «просто друг».",
        "status": "active",
        "button_emoji": "🌸",
        "is_visible": True,
    },
    "vika_01": {
        ...
        "gender": "female",
        "age": 35,
        "short_bio": "Твоя начальница. Строгая, требовательная и невыносимо притягательная — особенно когда остаётся с тобой допоздна и снимает пиджак.",
        "status": "active",
        "button_emoji": "👠",
        "is_visible": True,
    },
    "alisa_01": {
        ...
        "gender": "female",
        "age": 27,
        "short_bio": "Молодая учительница — умная, мягкая и чуть застенчивая. Задержалась после уроков «проверить тетради», но пишет тебе дольше, чем нужно.",
        "status": "active",
        "button_emoji": "📚",
        "is_visible": True,
    },
    "mila_01": {
        ...
        "gender": "female",
        "age": 30,
        "short_bio": "Соседка напротив — уютная и заботливая. Печёт пироги «лишним кусочком» и стучит по вечерам, когда у тебя грустный день.",
        "status": "active",
        "button_emoji": "☕",
        "is_visible": True,
    },
