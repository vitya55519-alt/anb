...
LIFE_BY_DAYPART = {
    'morning': [
        ...
        ('у окна', 'включила музыку и понемногу собираюсь', 'лёгкое'),
        ('на улице', 'вышла ненадолго по делам', 'бодрое'),
    ],
    'afternoon': [
        ('в городе', 'бегаю по делам', 'обычное'),
        ('в городе', 'остановилась на короткую паузу между делами', 'спокойное'),
...
LIFE_CHOICE_PRESETS = {
    'cafe': ('кафе', 'решила ненадолго сменить обстановку', 'лёгкое'),
